...
public class ListasSimplementeLigadas {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        window1.addComponent(new Button("Contar lo elementos de la lista", new Action() {
            @Override
            public void doAction() {
                ListasUtils<Integer>listasutils = new ListasUtils<Integer>();
                System.out.println(listasutils.count(lista.getInicio()));
            }
        }));
        
        window1.addComponent(new Button("Obtener el n-ésimo elemento", new Action() {
            @Override
            public void doAction() {
                //BOTON
            }
    ...
    public static void insertaNodoEnLista(final Lista<Integer> lista, final GUIScreen guiScreen, final Integer lugar) {
        ...
        Button appendButton = new Button("Agregar o borrar nodo", new Action() {
            @Override
            public void doAction() {
